    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-4 col-lg-4 ml-auto text-center my-auto">
                ...
                <a href="<?php echo esc_url( get_theme_mod( 'serenity_lite_cta_section_link', '#' ) ); ?>" class="btn btn-lg btn-pill btn-outline-light"><?php echo esc_html( get_theme_mod( 'serenity_lite_cta_section_btn', __( 'Download Now', 'serenity-lite' ) ) ); ?> <i class="fas fa-long-arrow-alt-right"></i></a>
