...
class serenity_lite_Welcome {
	...
	public function serenity_lite_welcome_screen() {
		...
		<div class="wrap about-wrap theme-welcome">
            ...
            <h1><?php esc_html_e('Welcome to Serenity Lite', 'serenity-lite'); ?> <span><?php esc_html_e('VERSION 1.0', 'serenity-lite'); ?></span></h1>
			...
			<ul class="nav-tab-wrapper" role="tablist">
	            ...
	            <li role="presentation" class="nav-tab"><a href="#theme_support" aria-controls="theme_support" role="tab" data-toggle="tab"><?php esc_html_e( 'Theme Support','serenity-lite'); ?></a></li>
